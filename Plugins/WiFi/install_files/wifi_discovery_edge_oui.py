...
class OperationMain(Operation):
    ...
    def _apply_parameters_from_runner(self) -> None:
        ...
        self.alert_on_new_target = bool(p.get("alert_on_new_target", self.alert_on_new_target))
    ...
    async def _emit_alert(
        ...
        # also send TAK event so WinTAK/ATAK alert table sees it
    ...
    def _bssid_matches_oui(self, bssid: str) -> bool:
        ...
        prefix = norm_bssid[:6]
        return prefix in self.oui_prefixes
