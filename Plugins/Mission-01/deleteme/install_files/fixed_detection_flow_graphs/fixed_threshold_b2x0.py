...
class fixed_threshold_b2x0(gr.top_block):
    ...
    def __init__(self, antenna_default='TX/RX', channel_default='A:A', gain_default='60', ip_address='', rx_freq_default='2412000000', sample_rate_default='20e6', serial='False', threshold_default='0'):
