...
class iq_recorder_b2x0(gr.top_block):
    ...
    def __init__(self, file_length="100000", filepath="", ip_address="192.168.40.2", rx_antenna="TX/RX", rx_channel="A:A", rx_frequency="2412", rx_gain="20", sample_rate="1", serial="False"):
        gr.top_block.__init__(self, "Iq Recorder B2X0")
