...
# Title: Iq Playback Single Cariboulite
...
class iq_playback_single_cariboulite(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Iq Playback Single Cariboulite", catch_exceptions=True)
...
def main(top_block_cls=iq_playback_single_cariboulite, options=None):
    tb = top_block_cls()
