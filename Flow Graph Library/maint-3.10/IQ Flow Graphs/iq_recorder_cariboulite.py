...
class iq_recorder_cariboulite(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Iq Recorder Cariboulite", catch_exceptions=True)
        ...
        self.soapy_custom_source_0.set_frequency(0, float(rx_frequency))
        ...
        self.connect((self.soapy_custom_source_0, 0), (self.blocks_skiphead_0, 0))
    ...
    def set_rx_frequency(self, rx_frequency):
        ...
        self.soapy_custom_source_0.set_frequency(0, float(self.rx_frequency))
...
def main(top_block_cls=iq_recorder_cariboulite, options=None):
    tb = top_block_cls()
