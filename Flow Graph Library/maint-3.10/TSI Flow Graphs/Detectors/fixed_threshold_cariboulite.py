...
class fixed_threshold_cariboulite(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, antenna_default='', channel_default='', gain_default='50', ip_address='', rx_freq_default='2412', sample_rate_default='20e6', sensor_node_ip_address="127.0.0.1", serial="0", threshold_default='0'):
        ...
        self.ainfosec_msg_str_to_PUB_1 = ainfosec.msg_str_to_PUB("tcp://127.0.0.1:5060")


        ##################################################
        # Connections
        ##################################################
        self.msg_connect((self.epy_block_0, 'detected_signals'), (self.ainfosec_msg_str_to_PUB_1, 'Message'))
...
def argument_parser():
    ...
    parser.add_argument(
        "--antenna-default", dest="antenna_default", type=str, default='',
        help="Set antenna_default [default=%(default)r]")
    parser.add_argument(
