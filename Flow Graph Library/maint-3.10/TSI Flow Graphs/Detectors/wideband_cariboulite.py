...
class wideband_cariboulite(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wideband Cariboulite", catch_exceptions=True)
        ...
        self.connect((self.soapy_custom_source_0, 0), (self.dc_blocker_xx_0, 0))
    ...
    def set_rx_freq(self, rx_freq):
        ...
        self.soapy_custom_source_0.set_frequency(0, float(self.rx_freq))
    ...
    def set_gain(self, gain):
        self.gain = gain
        self.soapy_custom_source_0.set_gain(0, float(self.gain))
...
def main(top_block_cls=wideband_cariboulite, options=None):
    tb = top_block_cls()
