...
class antenna_test_rx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Antenna Test Rx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Antenna Test Rx")
        ...
        self._freq_options = [915000000, 2412000000, 5800000000]
        # Create the labels list
        self._freq_labels = ['915', '2412', '5800']
