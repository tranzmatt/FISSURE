...
programs_raspberry_pi_os = []

# Misc. Dependencies
programs_raspberry_pi_os.append(('Misc. Dependencies',
...
cd ~/Installed_by_FISSURE  # netron
git clone https://github.com/lutzroeder/netron.git  # netron
cd netron  # netron
npm install  # netron
...
# fissure Commands
programs_raspberry_pi_os.append(('fissure Commands',
...
programs_raspberry_pi_os.append(('Password Prompt Exceptions',
...
# GNU Radio
programs_raspberry_pi_os.append(('GNU Radio',
...
# Wireshark
programs_raspberry_pi_os.append(('Wireshark',
...
programs_raspberry_pi_os.append(('Network Certificates',
"""cd '""" + fissure_directory + """'
...
Exec=lxterminal -e bash -c 'sleep 1; $HOME/.local/bin/fissure-sensor-node; exec bash'
EOF
...
# LimeSDR
programs_raspberry_pi_os.append(('LimeSDR',
...
# BladeRF
programs_raspberry_pi_os.append(('BladeRF',
...
# programs_raspberry_pi_os.append(('USRP X300 Series',
...
# HackRF, gr-osmosdr
programs_raspberry_pi_os.append(('HackRF, gr-osmosdr',
...
# 8812au Driver
programs_raspberry_pi_os.append(('8812au Driver',
...
# Zigbee Sniffer
programs_raspberry_pi_os.append(('Zigbee Sniffer',
"""mkdir -p ~/Installed_by_FISSURE
...
# fl2k
programs_raspberry_pi_os.append(('fl2k',
"""mkdir -p ~/Installed_by_FISSURE
cd ~/Installed_by_FISSURE
...
# Proxmark3
programs_raspberry_pi_os.append(('Proxmark3',
...
# PlutoSDR
programs_raspberry_pi_os.append(('PlutoSDR',
...
# qFlipper
programs_raspberry_pi_os.append(('qFlipper',
...
# gr-acars-3.10ng
programs_raspberry_pi_os.append(('gr-acars-3.10ng',
...
# gr-adsb
programs_raspberry_pi_os.append(('gr-adsb',
"""cd """ + fissure_directory + """
...
# gr-ainfosec
programs_raspberry_pi_os.append(('gr-ainfosec',
...
# gr-ais
programs_raspberry_pi_os.append(('gr-ais',
"""cd """ + fissure_directory + """
...
# gr-aistx
programs_raspberry_pi_os.append(('gr-aistx',
"""cd """ + fissure_directory + """
...
# gr-bluetooth
programs_raspberry_pi_os.append(('gr-bluetooth',
"""cd """ + fissure_directory + """
...
# gr-clapper_plus
programs_raspberry_pi_os.append(('gr-clapper_plus',
"""cd """ + fissure_directory + """
...
# gr-dect2
programs_raspberry_pi_os.append(('gr-dect2',
"""cd """ + fissure_directory + """
...
# gr-foo
programs_raspberry_pi_os.append(('gr-foo',
"""cd """ + fissure_directory + """
...
# gr-fuzzer
programs_raspberry_pi_os.append(('gr-fuzzer',
...
# gr-garage_door
programs_raspberry_pi_os.append(('gr-garage_door',
"""cd """ + fissure_directory + """
...
# gr-gsm
programs_raspberry_pi_os.append(('gr-gsm',
"""cd """ + fissure_directory + """
...
# gr-ieee802-11
programs_raspberry_pi_os.append(('gr-ieee802-11',
"""cd """ + fissure_directory + """
...
# gr-ieee802-15-4
programs_raspberry_pi_os.append(('gr-ieee802-15-4',
"""cd """ + fissure_directory + """
...
# gr-iridium
programs_raspberry_pi_os.append(('gr-iridium',
"""cd """ + fissure_directory + """
...
# gr-j2497
programs_raspberry_pi_os.append(('gr-j2497',
"""cd """ + fissure_directory + """
...
# gr-limesdr
programs_raspberry_pi_os.append(('gr-limesdr',
"""cd """ + fissure_directory + """
...
# gr-mixalot
programs_raspberry_pi_os.append(('gr-mixalot',
"""cd """ + fissure_directory + """
...
# gr-nrsc5
programs_raspberry_pi_os.append(('gr-nrsc5',
"""cd """ + fissure_directory + """
...
# gr-paint
programs_raspberry_pi_os.append(('gr-paint',
"""cd """ + fissure_directory + """
...
# gr-rds
programs_raspberry_pi_os.append(('gr-rds',
"""cd """ + fissure_directory + """
...
# gr-sidekiq
programs_raspberry_pi_os.append(('gr-sidekiq',
"""cd """ + fissure_directory + """
...
# gr-sdrplay3
programs_raspberry_pi_os.append(('gr-sdrplay3',
"""cd """ + fissure_directory + """
...
# gr-tpms
programs_raspberry_pi_os.append(('gr-tpms',
"""cd """ + fissure_directory + """
...
# gr-tpms_poore
programs_raspberry_pi_os.append(('gr-tpms_poore',
"""cd """ + fissure_directory + """
...
# gr-X10
programs_raspberry_pi_os.append(('gr-X10',
"""cd """ + fissure_directory + """
...
# gr-zwave_poore
programs_raspberry_pi_os.append(('gr-zwave_poore',
"""cd """ + fissure_directory + """
...
# QSpectrumAnalyzer
programs_raspberry_pi_os.append(('QSpectrumAnalyzer',
...
# Dump1090
programs_raspberry_pi_os.append(('Dump1090',
"""sudo apt-get install -y libusb-1.0-0-dev
...
# QtDesigner
programs_raspberry_pi_os.append(('QtDesigner',
...
# Kismet
programs_raspberry_pi_os.append(('Kismet',
...
# UDP Replay
programs_raspberry_pi_os.append(('UDP Replay',
...
programs_raspberry_pi_os.append(('srsRAN_4G',
...
programs_raspberry_pi_os.append(('FALCON',
...
# LTE-ciphercheck - Fix
programs_raspberry_pi_os.append(('LTE-ciphercheck',
...
# Aircrack-ng
programs_raspberry_pi_os.append(('Aircrack-ng',
...
# Geany
programs_raspberry_pi_os.append(('Geany',
...
# # Arduino IDE
# programs_raspberry_pi_os.append(('Arduino IDE',
...
# Minicom
programs_raspberry_pi_os.append(('Minicom',
...
# PuTTY
programs_raspberry_pi_os.append(('PuTTY',
...
# openHAB
programs_raspberry_pi_os.append(('openHAB',
...
# rtl-zwave
programs_raspberry_pi_os.append(('rtl-zwave',
"""mkdir -p ~/Installed_by_FISSURE
sudo apt-get install -y libpcap-dev
...
# waving-z
programs_raspberry_pi_os.append(('waving-z',
"""mkdir -p ~/Installed_by_FISSURE
cd ~/Installed_by_FISSURE/
...
# baudline
programs_raspberry_pi_os.append(('baudline',
"""mkdir -p ~/Installed_by_FISSURE
cd ~/Installed_by_FISSURE
...
# Inspectrum
programs_raspberry_pi_os.append(('Inspectrum',
...
# OpenCPN
programs_raspberry_pi_os.append(('OpenCPN',
...
# Kalibrate
programs_raspberry_pi_os.append(('Kalibrate',
"""mkdir -p ~/Installed_by_FISSURE
cd ~/Installed_by_FISSURE
...
# retrogram-rtlsdr
programs_raspberry_pi_os.append(('retrogram-rtlsdr',
"""mkdir -p ~/Installed_by_FISSURE
...
# RTLSDR-Airband
programs_raspberry_pi_os.append(('RTLSDR-Airband',
...
# Spektrum
programs_raspberry_pi_os.append(('Spektrum',
...
# SDRTrunk
programs_raspberry_pi_os.append(('SDRTrunk',
...
# Audacity
programs_raspberry_pi_os.append(('Audacity',
...
# Sound eXchange
programs_raspberry_pi_os.append(('Sound eXchange',
...
# LAME
programs_raspberry_pi_os.append(('LAME',
...
# mpv
programs_raspberry_pi_os.append(('mpv',
...
# FFmpeg
programs_raspberry_pi_os.append(('FFmpeg',
...
# MPlayer
programs_raspberry_pi_os.append(('MPlayer',
...
# VLC
programs_raspberry_pi_os.append(('VLC',
...
programs_raspberry_pi_os.append(('Simple Screen Recorder',
"""sudo apt-get install -y simplescreenrecorder  # Installs but does not support Wayland 
########## Verify ##########
simplescreenrecorder --help
""",False,'Video'))

# radiosonde_auto_rx
programs_raspberry_pi_os.append(('radiosonde_auto_rx',
...
# SdrGlut
programs_raspberry_pi_os.append(('SdrGlut',
...
# rehex
programs_raspberry_pi_os.append(('rehex',
...
# ZEPASSD
programs_raspberry_pi_os.append(('ZEPASSD',
...
# iridium-toolkit
programs_raspberry_pi_os.append(('iridium-toolkit',
...
# IridiumLive
programs_raspberry_pi_os.append(('IridiumLive',
"""mkdir -p ~/Installed_by_FISSURE
cd ~/Installed_by_FISSURE
...
# Wifite
programs_raspberry_pi_os.append(('Wifite',
...
# rtl_433
programs_raspberry_pi_os.append(('rtl_433',
...
# Metasploit
programs_raspberry_pi_os.append(('Metasploit',
"""mkdir -p ~/Installed_by_FISSURE
cd ~/Installed_by_FISSURE
mkdir metasploit
cd metasploit
...
# monitor_rtl433
programs_raspberry_pi_os.append(('monitor_rtl433',
"""mkdir -p ~/Installed_by_FISSURE
cd ~/Installed_by_FISSURE
...
# minimodem
programs_raspberry_pi_os.append(('minimodem',
...
# WSJT-X
programs_raspberry_pi_os.append(('WSJT-X',
...
# Google Earth Pro
programs_raspberry_pi_os.append(('Google Earth Pro',
"""mkdir -p ~/Installed_by_FISSURE
cd ~/Installed_by_FISSURE
...
# gr-air-modes
programs_raspberry_pi_os.append(('gr-air-modes',
...
# ESP8266 Deauther v2
programs_raspberry_pi_os.append(('ESP8266 Deauther v2',
"""mkdir -p ~/Installed_by_FISSURE
cd ~/Installed_by_FISSURE
...
# Viking
programs_raspberry_pi_os.append(('Viking',
"""mkdir -p ~/Installed_by_FISSURE
cd ~/Installed_by_FISSURE
...
# Gpredict
programs_raspberry_pi_os.append(('Gpredict',
...
# FoxtrotGPS
programs_raspberry_pi_os.append(('FoxtrotGPS',
...
# Xastir
programs_raspberry_pi_os.append(('Xastir',
...
# LTE-Cell-Scanner
programs_raspberry_pi_os.append(('LTE-Cell-Scanner',
...
# btscanner
programs_raspberry_pi_os.append(('btscanner',
...
# hcidump
programs_raspberry_pi_os.append(('hcidump',
...
# GraphicsMagick
programs_raspberry_pi_os.append(('GraphicsMagick',
...
# nrsc5 and nrsc5-gui
programs_raspberry_pi_os.append(('nrsc5',
...
# HAM2MON
programs_raspberry_pi_os.append(('HAM2MON',
"""mkdir -p ~/Installed_by_FISSURE
cd ~/Installed_by_FISSURE
...
# Anki
programs_raspberry_pi_os.append(('Anki',
...
# Bless
programs_raspberry_pi_os.append(('Bless (4.00 kB)',
...
# airgeddon
programs_raspberry_pi_os.append(('airgeddon',
...
# Hydra
programs_raspberry_pi_os.append(('Hydra',
...
# Enscribe
programs_raspberry_pi_os.append(('Enscribe',
...
programs_raspberry_pi_os.append(('ESP32 BT Classic Sniffer',
...
# SigDigger
programs_raspberry_pi_os.append(('SigDigger (48.00 kB)',
...
# QSSTV
programs_raspberry_pi_os.append(('QSSTV',
...
# m17-cxx-demod
programs_raspberry_pi_os.append(('m17-cxx-demod',
...
# Fldigi
programs_raspberry_pi_os.append(('Fldigi',
...
# Dire Wolf
programs_raspberry_pi_os.append(('Dire Wolf',
...
# Meld
programs_raspberry_pi_os.append(('Meld',
...
# HamClock
programs_raspberry_pi_os.append(('HamClock',
"""mkdir -p ~/Installed_by_FISSURE
cd ~/Installed_by_FISSURE
...
programs_raspberry_pi_os.append(('ICE9 Bluetooth Sniffer',
...
# dump978
programs_raspberry_pi_os.append(('dump978',
"""mkdir -p ~/Installed_by_FISSURE
cd ~/Installed_by_FISSURE
...
# htop
programs_raspberry_pi_os.append(('htop',
...
# OpenWebRX
programs_raspberry_pi_os.append(('OpenWebRX',
...
# CRC RevEng
programs_raspberry_pi_os.append(('CRC RevEng',
"""mkdir -p ~/Installed_by_FISSURE
cd ~/Installed_by_FISSURE
...
# wl-color-picker
programs_raspberry_pi_os.append(('wl-color-picker',
...
# GHex
programs_raspberry_pi_os.append(('GHex',
...
# HAMRS
programs_raspberry_pi_os.append(('HAMRS',
...
# IQEngine
programs_raspberry_pi_os.append(('IQEngine',
...
# TAK Server
programs_raspberry_pi_os.append(('TAK Server',
...
programs_raspberry_pi_os.append(('Mobile Atlas Creator',
